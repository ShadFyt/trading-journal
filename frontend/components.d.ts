...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    ScalePlanFormFields: typeof import('@/components/scale-plan/scale-forms/ScalePlanFormFields.vue')['default']
    ScalePlanHoverCard: typeof import('./src/components/scale-plan/scale-plan/ScalePlanHoverCard.vue')['default']
    ScalePlanHoverCardItem: typeof import('@/components/scale-plan/scale-plan/ScalePlanHoverCardItem.vue')['default']
    ScalePlanMenu: typeof import('./src/components/scale-plan/scale-plan/ScalePlanMenu.vue')['default']
    ScalePlanQuickAdd: typeof import('@/components/scale-plan/scale-forms/ScalePlanQuickAdd.vue')['default']
    ScalePlanQuickEdit: typeof import('@/components/scale-plan/scale-forms/ScalePlanQuickEdit.vue')['default']
    ...
    TradeExecutionForm: typeof import('@/components/scale-plan/scale-forms/TradeExecutionForm.vue')['default']
