...
const tradeType = defineModel<ScalePlanCreate['tradeType']>()
</script>

<template>
  <FormField class="space-y-2" name="tradeType">
    <FormItem>
      ...
      <Select v-model="tradeType">
        ...
        <SelectContent class="bg-slate-800 border-slate-600">
          <SelectGroup>
            ...
            <SelectItem value="short" class="text-slate-200 focus:bg-slate-700">Short</SelectItem>
          </SelectGroup>
        </SelectContent>
      </Select>
