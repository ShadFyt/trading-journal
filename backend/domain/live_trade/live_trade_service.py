...
class LiveTradeService:
    def __init__(self, repo: LiveTradeRepo, annotation_repo: AnnotationRepo, trade_idea_service: TradeIdeaService, stock_price_service: StockPriceService):
        self.repo = repo
    ...
    async def get_all_live_trades(self) -> list[LiveTradeResponse]:
        ...
        live_trades = [LiveTradeResponse.model_validate(trade) for trade in db_live_trades]
