...
Revision ID: c364d0468466
Revises: 
Create Date: 2025-08-12 11:40:46.114937
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_trade_idea_symbol'), 'trade_idea', ['symbol'], unique=False)
    ...
    op.create_index(op.f('ix_live_trade_symbol'), 'live_trade', ['symbol'], unique=False)
