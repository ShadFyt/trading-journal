...
class CompanyProfile(BaseModel):
    ...
    cap: str = Field(str, alias="marketCapitalization", description="Market cap")
    name: str = Field(str, description="Company name")
    symbol: str = Field(str, alias="ticker", description="Ticker")
    web_url: str = Field(str, alias="weburl", description="Company website")
    logo: str = Field(str, description="Company logo")
    industry: str = Field(str, alias="finnhubIndustry", description="Industry")
    model_config = ConfigDict(populate_by_name=True)
