...
class CompanyProfile(BaseModel):
    country: str = Field(str, description="Country")
    currency: str = Field(str, description="Currency")
    exchange: str = Field(str, description="Exchange")
    marketCapitalization: float = Field(float, alias="cap", description="Market cap")
    name: str = Field(str, description="Company name")
    ticker: str = Field(str, alias="symbol", description="Ticker")
    web_url: str = Field(str, alias="weburl", description="Company website")
    logo: str = Field(str, description="Company logo")
    finnhubIndustry: str = Field(str, alias="industry", description="Industry")
    model_config = ConfigDict(populate_by_name=True)
